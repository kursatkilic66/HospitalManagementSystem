...
public class Patient {
    ...
    private String name;
    private MyLinkedList medicalHistory;
    ...
    public Patient(MyLinkedList medicalHistory, String name, int priorityLevel, int age, int patientID) {
    ...
    public MyLinkedList getMedicalHistory() {
        return medicalHistory;
    }

    public void setMedicalHistory(MyLinkedList medicalHistory) {
        this.medicalHistory = medicalHistory;
    }
}
